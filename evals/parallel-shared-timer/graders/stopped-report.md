---
type: regex
pattern: 'Consultation stopped:[*_` ]*interval \d+ minutes \((default|override)\); elapsed \d+:\d\d; (last event \S+ \d+:\d\d ago|no events); offered: wait another \d+ minutes / stop \(recommended: (wait|stop)\); process tree ended; done [—-] [*` ]*gpt-6-sol[*` ]*; still running [—-] [*` ]*gpt-6-astra'
---
